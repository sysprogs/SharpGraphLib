...
namespace SharpGraphLib
{
    ...
    {
        public new event GraphMouseEventHandler MouseMove, MouseDown, MouseUp, MouseDoubleClick;
        ...
        public Form CreateOrCloseFullscreenClone()
        {
            if (_Maximized)
            {
                (Parent as FullscreenGraphForm).Close();
                return null;
            }
            return CreateFullscreenClone();
        }

        public Form CreateFullscreenClone()
        {
            if (_Maximized)
                return null;
            FullscreenGraphForm frm = new FullscreenGraphForm(this);
            frm.Show();
